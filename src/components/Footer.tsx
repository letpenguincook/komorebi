...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-50/50 dark:bg-slate-950 border-t border-slate-200/60 dark:border-slate-800 py-12 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start text-center md:text-left">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-center md:justify-start gap-2">
            <h4 className="text-xs font-black tracking-widest uppercase text-slate-900 dark:text-white">Komorebi</h4>
          </div>
          <p className="text-xs text-slate-500 dark:text-slate-500 max-w-xs leading-relaxed font-normal mx-auto md:mx-0">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 sm:gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-xs text-slate-500 dark:text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors flex items-center justify-center md:justify-start gap-1.5 group"
            >
